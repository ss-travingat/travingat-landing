      ...
      <form onSubmit={handleCreate} className="flex h-full flex-col w-full relative bg-[#111]">
        ...
        <div className="flex flex-col">
          <Field label="Upload profile photo">
            <div className="relative inline-block w-max group">
              <div className={`group flex h-[80px] w-[80px] cursor-pointer items-center justify-center overflow-hidden rounded-[12px] border bg-black relative ${errors.profileImage ? 'border-red-500' : 'border-[#2a2a2a]'}`}>
                {form.profileImage ? (
                  <>
        ...
        <div className="flex flex-col">
          <Field label="Upload cover photo">
            <div className="relative inline-block w-max group">
              <div className={`group flex h-[131px] w-[200px] cursor-pointer items-center justify-center overflow-hidden rounded-[12px] border bg-black relative ${errors.coverImage ? 'border-red-500' : 'border-[#2a2a2a]'}`}>
                {form.coverImage ? (
                  <>
