                          ...
                          <div key={globalIndex} className="group relative">
                            ...
                            >
                              {isVideo ? (
                                <>
                                  <LoadedImage
                                    originalSrc={MediaResolver.getBase(imgUrl)} src={MediaResolver.getThumbnail(MediaResolver.getBase(imgUrl), 720)}
                                    thumbnailSrc={MediaResolver.getThumbnail(MediaResolver.getBase(imgUrl), 320)}
                                    alt={`${title} video ${globalIndex + 1}`}
                                    className="w-full h-auto block"
                                    containerClassName="w-full"
                                    skeletonClassName="w-full aspect-square bg-[#1a1a1a]"
                                  />
