export function buildWelcomeWaitlistEmail(ctaUrl: string): string {
  return `
    <!DOCTYPE html>
    <html>
    <head>
      ...
      <div class="wc-wrapper">
        <div class="wc-container">
          ...
          <div class="wc-text-content">
            ...
            <p class="wc-text">
              You're officially on the waitlist. While you wait, create your free Explorer Card and showcase the countries you've explored.
            </p>
          </div>
          
          <a href="${ctaUrl}" class="wc-btn-primary">Create your explorer card</a>
        </div>
