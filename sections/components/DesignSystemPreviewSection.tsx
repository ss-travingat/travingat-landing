...
export default function DesignSystemPreviewSection() {
  return (
    <section className="px-3 py-12 md:px-12 md:py-16 xl:px-24 xl:py-20">
      <div className="rounded-[24px] border border-[#20242d] bg-[#0d1017] p-5 md:p-8 xl:p-10">
        <div className="mb-8 flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="ds-font-body mt-3 max-w-[700px] text-[17px] leading-7 text-[#aeb7ca]">
          ...
          <Link
            href="/designsystem"
            className="ds-font-body inline-flex h-12 items-center justify-center rounded-full bg-white px-6 text-[15px] font-semibold text-black transition hover:bg-[#efefef]"
          >
            Open /designsystem
          </Link>
        </div>
        ...
        <div className="grid gap-4 xl:grid-cols-2">
          <div className="rounded-[16px] border border-[#1f2430] bg-black p-5">
