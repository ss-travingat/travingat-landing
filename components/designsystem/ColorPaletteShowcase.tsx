...
function PaletteRow({ group }: { group: PaletteGroup }) {
  return (
    <div className="mb-8">
      ...
      <div>
        <div className="grid grid-cols-3 gap-3 sm:grid-cols-4 md:grid-cols-6 xl:grid-cols-11">
...
export default function ColorPaletteShowcase({ withSidebar = true }: ColorPaletteShowcaseProps) {
  ...
  return (
    <section className="px-3 py-10 md:px-10 md:py-14 xl:px-24 xl:py-16">
      <div className="ds-shell md:grid md:grid-cols-[340px_minmax(0,1fr)] xl:grid-cols-[380px_minmax(0,1fr)]">
        <FoundationSidebar
          title="Color Palette"
